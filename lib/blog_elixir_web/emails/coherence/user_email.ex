...
defmodule BlogElixirWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: BlogElixirWeb.Coherence.EmailView, layout: {BlogElixirWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
